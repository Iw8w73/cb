...
bot = telebot.TeleBot('7794113076:AAG8002CcLmM2UXwQKTvAHBLL5WIM9p7RTQ')
...
def add_user(message):
    ...
    if user_id in admin_id:
        ...
        response = "ꜰʀᴇᴇ ᴋᴇ ᴅʜᴀʀᴍ ꜱʜᴀʟᴀ ʜᴀɪ ᴋʏᴀ ᴊᴏ ᴍᴜ ᴜᴛᴛʜᴀ ᴋᴀɪ ᴋʜɪ ʙʜɪ ɢᴜꜱ ʀʜᴀɪ ʜᴏ ʙᴜʏ ᴋʀᴏ ꜰʀᴇᴇ ᴍᴀɪ ᴋᴜᴄʜ ɴʜɪ ᴍɪʟᴛᴀ ʙᴜʏ:- @HACK_KING160 ❄."
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = ("🚫 Unauthorized Access! 🚫\n\nOops! It seems like you don't have permission to use the /bgmi command.                                                                          DM TO BUY ACCESS:- @HACK_KING160")
...
Buy From :- @HACK_KING160
Official Channel :- https://t.me/HACK_KING160
'''
...
3. MAKE SURE YOU JOINED https://t.me/HACK_KING160 OTHERWISE NOT WORK
...
Vip 🌟 :
-> Attack Time : 120 (S)
> After Attack Limit : 150 sec
-> Concurrents Attack : unlimited 
